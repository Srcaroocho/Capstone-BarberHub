...
const ClientTable = () => {
    ...
    const filteredClients = Array.isArray(clientsData) ? clientsData.filter(cliente =>
        cliente.Nombre.toLowerCase().includes(searchTerm.toLowerCase()) ||
        cliente.Apellido.toLowerCase().includes(searchTerm.toLowerCase()) ||
        cliente.Email.toLowerCase().includes(searchTerm.toLowerCase()) ||
        cliente.Especialidad.toLowerCase().includes(searchTerm.toLowerCase())
    ) : [];
            ...
            <table className="client-table">
                <thead className="client-table-header">
                    <tr className="client-table-row">
                        <th className="client-table-heading">
                        </th>
