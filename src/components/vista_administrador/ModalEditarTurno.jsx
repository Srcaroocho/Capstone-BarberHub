    ...
    try {
      if (turno) {
        ...
        const newData = {
          EmpleadoID,
          Fecha,
          HoraEntrada: modifiedTurno.HoraEntrada,
          HoraSalida: modifiedTurno.HoraSalida,
            ...
            <>
              ...
              <div className="schedule-modify-info">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setModifiedTurno({ ...modifiedTurno, HoraEntrada: e.target.value })
                  }
                />
                ...
                <input
                  ...
                  onChange={(e) =>
                    setModifiedTurno({ ...modifiedTurno, HoraSalida: e.target.value })
                  }
                />               
              </div>
              <div className="schedule-modify-buttons">
                <button className="modal-modify-button" onClick={handleModify}>
                  Modificar
                </button>
